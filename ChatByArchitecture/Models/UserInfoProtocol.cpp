...
QJsonObject UserInfoProtocol::appendToSonsJson(QJsonObject* obj)
{
	obj->insert("name", name);
	obj->insert("nickName", nickName);
	obj->insert("uuid", uuid);
...
void UserInfoProtocol::appendToSonsValue(QJsonObject* obj)
{
	this->name = obj->value("namee").toString();
	this->nickName = obj->value("nickName").toString();
	this->uuid = obj->value("uuid").toString();
